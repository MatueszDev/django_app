...
class EventForm(forms.Form):
    ...
    starting_time = forms.TimeField(label='start', widget=forms.TextInput({ "placeholder": "12:00:00" }))
    ending_time = forms.TimeField(label='end', widget=forms.TextInput({ "placeholder": "13:30:00" }))
